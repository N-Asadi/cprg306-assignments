    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 pt-10">
      <div className="max-w-md mx-auto p-4 border rounded-lg shadow-lg bg-white">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-blue-500 hover:bg-blue-600 text-white text-lg font-semibold py-2 px-4 rounded-lg shadow-md focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            Add Item
          </button>
        </form>
